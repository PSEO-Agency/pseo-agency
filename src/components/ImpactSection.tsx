    ...
    <section className="py-24 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 mb-8 leading-tight text-balance">
          ...
          {stats.map((stat, index) => {
            ...
            return (
              <div key={index} className="webfx-stats-card text-center group hover:scale-105 transition-all duration-300">
                ...
                <div className="text-4xl sm:text-5xl font-black text-gray-900 mb-3">{stat.number}</div>
                <div className="text-base sm:text-lg font-bold text-gray-900 mb-2">{stat.label}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-20">
          {achievements.map((achievement, index) => {
            ...
            return (
              <div key={index} className="webfx-card p-6 sm:p-8 text-center group hover:scale-105 transition-all duration-300">
        ...
        <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-16 text-white relative overflow-hidden">
          {/* Background decoration */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center relative z-10">
            <div>
              <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-balance">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button 
                  className="webfx-button-primary text-base sm:text-lg px-8 sm:px-10 py-4 sm:py-6 h-auto"
                  onClick={() => setIsAuditModalOpen(true)}
                >
                  Get Your Free SEO Strategy
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
                <div className="flex items-center justify-center sm:justify-start space-x-3 text-blue-200">
            ...
            <div className="relative">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-white/20">
                <div className="text-2xl sm:text-3xl font-bold text-green-300 mb-4 sm:mb-6">ROI Calculator Preview</div>
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex justify-between items-center py-2 sm:py-3 border-b border-white/20">
                    <span className="text-blue-200 text-sm sm:text-base">Current Monthly Traffic:</span>
                    <span className="font-bold text-white text-base sm:text-lg">10,000 visitors</span>
                  </div>
                  <div className="flex justify-between items-center py-2 sm:py-3 border-b border-white/20">
                    <span className="text-blue-200 text-sm sm:text-base">Projected Growth:</span>
                    <span className="font-bold text-green-300 text-lg sm:text-xl">+800% (90,000)</span>
                  </div>
                  <div className="flex justify-between items-center py-2 sm:py-3">
                    <span className="text-blue-200 text-sm sm:text-base">Additional Monthly Revenue:</span>
                    <span className="font-bold text-green-300 text-xl sm:text-2xl">$85,000+</span>
                  </div>
                </div>
                <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-green-500/20 rounded-xl border border-green-400/20">
