...
import { Users, Target, Zap, Award, TrendingUp, Globe, Rocket, Shield, Database, Settings, BarChart3, Code } from "lucide-react";
  ...
  const coreValues = [
    {
      ...
      description: "Building sophisticated systems that scale SEO operations without manual intervention, from keyword research to content generation."
    },
    {
      icon: <BarChart3 className="h-8 w-8 text-green-600" />,
      title: "Data-Driven Results",
      description: "Every programmatic strategy is backed by comprehensive data analysis, proven methodologies, and continuous performance optimization."
    },
    {
      icon: <Database className="h-8 w-8 text-purple-600" />,
      title: "Industry Expertise",
      description: "Specialized programmatic SEO knowledge across E-commerce, SaaS, Real Estate, Healthcare, Finance, Legal, and Local Business verticals."
    },
    {
      icon: <Code className="h-8 w-8 text-orange-600" />,
      title: "Scalable Solutions",
      description: "From 1,000 to 25,000+ pages per project, our programmatic approaches scale seamlessly with your business growth needs."
    }
  ];
  ...
  const processSteps = [
    {
      ...
      description: "Identify high-volume keywords, analyze competitors, and map dynamic data sources for maximum programmatic impact.",
      icon: <Target className="h-6 w-6" />
    },
    {
      number: "02", 
      title: "Template Development",
      description: "Create scalable, SEO-optimized templates that automatically generate thousands of unique, high-quality pages.",
      icon: <Code className="h-6 w-6" />
    },
    {
      number: "03",
      title: "Database & Content Setup", 
      description: "Build structured data foundations and automated content systems to power mass page generation at scale.",
      icon: <Database className="h-6 w-6" />
    },
    {
      number: "04",
      title: "Scale & Traffic Growth",
      description: "Launch thousands of optimized pages simultaneously and track performance for exponential traffic growth.",
      icon: <TrendingUp className="h-6 w-6" />
    }
  ];

  const industries = [
    "E-commerce & Retail", "SaaS & Technology", "Real Estate", "Healthcare & Medical",
    "Finance & Insurance", "Legal Services", "Local Business", "Accounting & Professional Services"
  ];
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                <div className={`inline-flex items-center justify-center w-16 h-16 bg-gray-100 rounded-full mb-4 group-hover:bg-gray-200 transition-colors ${stat.color}`}>
                  {stat.icon}
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  ...
                  access to sophisticated, scalable SEO automation that eliminates manual work and maximizes results.
                </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Our proven 4-step methodology automates SEO operations and scales organic traffic exponentially
              </p>
            </div>
              ...
              {caseStudyResults.map((result, index) => (
                <Card key={index} className="text-center border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                  <CardHeader>
                    ...
                    <CardTitle className="text-lg text-gray-900 font-semibold">{result.description}</CardTitle>
                    <CardDescription className="text-sm text-gray-600">{result.timeframe}</CardDescription>
                  </CardHeader>
                </Card>
              ))}
            </div>
