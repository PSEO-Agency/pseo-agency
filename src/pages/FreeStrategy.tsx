...
import { ArrowRight, CheckCircle2, Star, TrendingUp, Target, BarChart3 } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              Get Your <span className="webfx-text-gradient">Free pSEO Strategy</span>
            </h1>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-8">What You'll Get in Your Strategy Session</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Keyword Opportunity Analysis</h3>
                    <p className="text-gray-600">Identify high-volume, low-competition keywords specific to your domain and industry</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Get realistic projections of organic traffic growth with programmatic SEO implementation</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Discover what your competitors are missing and how to capitalize on those opportunities</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Custom Implementation Roadmap</h3>
                    <p className="text-gray-600">Step-by-step plan tailored to your business goals and technical requirements</p>
                  </div>
                </div>
              </div>
